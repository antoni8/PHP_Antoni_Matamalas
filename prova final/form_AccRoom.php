...
//emmagatzemar en una variable els serveis de restauració seleccionats
  ...
  if($viewsPrice>0&&$foodServicesPrice>0) 	 //visusi corrections - Be attentive to solution in class
    $partialPrice2=($viewsPrice+$foodServicesPrice);
  //sino asignar valor 0 a $partialPrice2 	 //visusi corrections - Be attentive to solution in class
  $partialPrice2=0;
...
<!--1. configura el metode PHP que mostra els parametres a la url del navegador-->
  <FORM ACTION="<?php echo $_SERVER["PHP_SELF"];?>" METHOD="GET">
    ...
    if ((isset($finalPrice)))
        ...
        echo 'El preu final és: '. $finalPrice;

        echo "<br>". typePriceCalculation($type);
        echo genderPriceCalculation($gender);
        echo viewsPriceCalculation($views);
        echo foodServicesPriceCalculation($foodServices);
  ?>
</body>
</HTML>
